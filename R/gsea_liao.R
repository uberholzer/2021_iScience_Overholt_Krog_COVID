...
dataset_liao <- "Liao_" # Enter the dataset header

# Severe vs Healthy Control comparison
de_celltypes_liao <- c(
  "CD14 Mono",
  "CD16 Mono",
  "CD4 Naive T",
...
groups1_liao <- c("Severe","Mild") # Enter the test severity categories here (FC=group1/group2)
groups2_liao <- c("Healthy Control") # Enter the reference severity categories here

run_GSEA(dataset_liao,de_celltypes_liao,groups1_liao,groups2_liao)

# Severe vs. Mild comparison
de_celltypes_liao <- c(
  "CD14 Mono",
  "CD16 Mono",
  "CD4 Naive T",
...
groups1_liao <- c("Severe") # Enter the test severity categories here (FC=group1/group2)
groups2_liao <- c("Mild") # Enter the reference severity categories here
