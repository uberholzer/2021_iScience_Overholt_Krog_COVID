...
dataset_wauters <- "Wauters_" # Enter the dataset header
de_celltypes_wauters  <- c(
  "CD14 Mono",
  # "CD16 Mono",
  # "CD4 Naive T",
  "CD4 Treg",
...
groups1_wauters <- c("Severe") # Enter the test severity categories here (FC=group1/group2)
groups2_wauters <- c("Mild") # Enter the reference severity categories here

run_GSEA(dataset_wauters,de_celltypes_wauters,groups1_wauters,groups2_wauters)
