...
dataset_lee <- "Lee_" # Enter the dataset header
de_celltypes_lee <- c("CD14 Mono",
                       "CD16 Mono",
                       "CD4 Naive T",
                       "CD4 Treg",
                       "CD8 Effector T",
...
groups1_lee <- c("Severe","Mild") # Enter the test severity categories here (FC=group1/group2)
groups2_lee <- c("Healthy Control","Mild") # Enter the reference severity categories here

run_GSEA(dataset_lee,de_celltypes_lee,groups1_lee,groups2_lee)
