...
dataset_schulte <- "Schulte_" # Enter the dataset header
de_celltypes_schulte  <- c(
  "CD14 Mono",
  "CD16 Mono",
  "CD4 Naive T",
  "CD4 Treg",
...
groups1_schulte <- c("Severe") # Enter the test severity categories here (FC=group1/group2)
groups2_schulte <- c("Mild") # Enter the reference severity categories here

run_GSEA(dataset_schulte,de_celltypes_schulte,groups1_schulte,groups2_schulte)
